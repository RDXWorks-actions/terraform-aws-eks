...
module "eks_managed_node_group" {
  ...
  # Security group
  vpc_security_group_ids            = compact(try(each.value.vpc_security_group_ids, var.eks_managed_node_group_defaults.vpc_security_group_ids, [local.node_security_group_id]))
